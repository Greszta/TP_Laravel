...
@section('content')
    <h2 class="text-center mt-4 mb-4">@lang('Create Post')</h2>
    <div class="container">
                        ...
                        <div class="card-body">
                            <form action="{{ route('articles.store')}}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" rows="4" class="form-control @error('content_en') is-invalid @enderror"" id="content_en" name="content_en" placeholder="@lang('lang.write_post')">{{ old('content_en') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" rows="4" class="form-control" id="content_fr" name="content_fr" placeholder="@lang('lang.write_post')">{{ old('content_en') }}</textarea>
                                </div>
                                <div class="d-grid">
